...
const (
	...
	addContainerPatch string = `[
		 {"op":"add","path":"/spec/containers/-","value":{"image":"registry.cn-shanghai.aliyuncs.com/acs/pause-amd64:3.0","name":"webhook-added-container","resources":{}}}
	]`
	addFirstContainerPatch string = `[
		{"op":"add","path":"/spec/containers","value":[{"image":"registry.cn-shanghai.aliyuncs.com/acs/pause-amd64:3.0","name":"webhook-added-container","resources":{}}]}
    ]`
)
...
func mutatePods(ar v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
	...
	if len(pod.Spec.Containers) != 0 {
		...
		reviewResponse.Patch = []byte(addFirstContainerPatch)
	}
